    ...
    if (_dateStart != null || _dateEnd != null) {
      filtered = filtered.where((sale) {
        ...
        if (_dateEnd != null) {
          ...
          if (saleDate.isAfter(endDate)) return false;
        }
                            ...
                            children: [
                              ...
                              if (_dateStart != null)
                                IconButton(
                                  ...
                                  onPressed: () => setState(() => _dateStart = null),
